...
namespace LigaProTrabajoenGrupo.Controllers
{
    public class ReportesController : Controller
    {
        ...
        public ReportesController(DBSqlSERVERLigaProECU context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ReporteId")] Reporte reporte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReporteId")] Reporte reporte)
        {
